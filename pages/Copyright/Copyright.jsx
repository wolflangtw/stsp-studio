...
export default function Copyright() {
    return (
        <div className={styles.Copyright}>
            <Head>
                <title>隱私權政策 | STSP Studio</title>
                <meta property="og:title" content="隱私權政策 | STSP Studio" />
            ...
            <div className={styles.text}>
                ...
                <h1>六、Cookie之使用</h1>
                <p>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，請直接關閉網站。</p>
                <h1>七、隱私權保護政策之修正</h1>
                <p>本網站隱私權保護政策將因應需求隨時進行修正，修正後的條款將刊登於網站上。 第三方廠商 (包括 Google) 會使用 Cookie，根據使用者先前在您網站 (或其他網站) 上瀏覽的內容放送廣告。</p>
                <h1>八、聯繫管道</h1>
                <p>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請前往Discord群組。</p>
            </div>
        </div>
    );
}
